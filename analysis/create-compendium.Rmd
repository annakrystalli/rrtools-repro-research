...
**Paste your copied PAT into your `.Renviron`** file as system variable `GITHUB_PAT`, save and close.
...
Next, we'll **create a GitHub repository to share our compendium**. We can do this with function:
...
At this point, let's copy `gillespie.csv` from the course materials you downloaded in `rrtools-wkshp-materials-master/` to the subfolder `analysis/data/raw_data/` in `rrcompendium`
